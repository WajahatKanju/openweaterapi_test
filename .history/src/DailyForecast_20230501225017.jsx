...
const CurrentWeather = () => {
  ...
  if (!weatherData) {
    return <div style={{ color: 'red'}}>Unable to retrieve current weather data. It seems that the API call limit has been exceeded or the current weather is not included in the free API plan.</div>;
  }
